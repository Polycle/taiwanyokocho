const seating = {
  first: [
    ...
    ["宮嶋優志", "篠原亜水", "佐伯楓", "玉城愛希", "八柳翔空", "山田美海華", "佐々木華", "西村歩珠美", "村上蒔志", "鈴木鴻之介"],
    ["青柳芽", "今村雛乃", "上原多一陽", "芹川ひかり", "中村崇真", "橋口けい", "渋谷祐名", "森優咲", "具志堅未來", "篠田沙羅"],
  ...
  second: [
    ...
    ["林楚凌", "今村雛乃", "徳竹優子", "山田康輔", "千輪柊菜", "松島碧", "佐々木華", "篠田沙羅", "阿部翔汰郎", "橋本芽生"],
    ["上原多一陽", "板橋紗英", "神田大翔", "松尾天音", "布施帆海", "植田杏", "奈良日菜子", "佐伯楓", "小川小次郎", "毛謙鎧"],
    ["小林翼", "安井逢紀人", "池田大将", "ほなみ", "澤田穂香", "柴崎優", "具志堅未來", "芹川ひかり", "松尾咲音", "東風平美玲"],
  ],
};
